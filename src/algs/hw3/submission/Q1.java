...
public class Q1 {
	...
	public static void trial1_1() {
		...
		Integer vals[] = new Integer[8];
		for (int i = 0; i < vals.length; i++) { vals[i] = StdRandom.uniform(10); }
		
		CountedItem<Integer>[] copy = toCountedArray(vals);
		insertionSort(copy);
