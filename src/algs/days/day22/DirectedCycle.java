...
// java algs.days.day22.DirectedCycle cycles.txt
//
// This works (java edu.princeton.cs.algs4.DirectedCycle cycles.txt)
public class DirectedCycle {
	 ...
	 * @param G the digraph
	 */
	public DirectedCycle(LectureDigraph G) {
	...
	void dfs(LectureDigraph G, int v) {
		...
		for (int w : G.adj(v)) {
			...
			// terminate once a cycle has been found. MY MISTAKE! I had this outside for loop...
			if (hasCycle()) { return; }
	...
	public static void main(String[] args) {
		In in = new In(args[0]);
		LectureDigraph dg = new LectureDigraph(in);
