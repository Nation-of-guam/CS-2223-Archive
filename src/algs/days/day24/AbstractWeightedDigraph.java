 ...
 * with it.  Show differences between AdjacencyList and AdjacencyMatrix.
 */
public abstract class AbstractWeightedDigraph {
     ...
     */
    public AbstractWeightedDigraph(int V) {
     ...
     */
    public AbstractWeightedDigraph(In in) {
        this(in.readInt());
        int E = in.readInt();
        for (int i = 0; i < E; i++) {
            int v = in.readInt();
